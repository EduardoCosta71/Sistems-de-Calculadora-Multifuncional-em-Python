## Projeto em Python – Calculadora Multifuncional
 ...
 - Conversão de unidades de medida (quilômetros, metros e horas)
 - Cálculo da área de figuras geométricas (quadrado, retângulo, triângulo e círculo)
...
Esse projeto foi uma ótima oportunidade para reforçar a lógica de programação e entender melhor como estruturar um programa que interage com o usuário.
